(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.8d15d.js';
        if (jsList) {
        ...
        var option = {
            ...
            // debugMode: settings.debug ? cc.DebugMode.INFO : cc.DebugMode.INFO,
            debugMode: settings.debug ? cc.DebugMode.INFO : cc.DebugMode.WARN,
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.cb0d9.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.8084b.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.8084b.js';
